...
type PrimeService interface {
	GetPrime(ctx context.Context, in *PrimeRequest, opts ...client.CallOption) (*PrimeRepose, error)
}
...
func (c *primeService) GetPrime(ctx context.Context, in *PrimeRequest, opts ...client.CallOption) (*PrimeRepose, error) {
...
type PrimeHandler interface {
	GetPrime(context.Context, *PrimeRequest, *PrimeRepose) error
}

func RegisterPrimeHandler(s server.Server, hdlr PrimeHandler, opts ...server.HandlerOption) error {
	type prime interface {
		GetPrime(ctx context.Context, in *PrimeRequest, out *PrimeRepose) error
	}
	type Prime struct {
		prime
	}
...
func (h *primeHandler) GetPrime(ctx context.Context, in *PrimeRequest, out *PrimeRepose) error {
