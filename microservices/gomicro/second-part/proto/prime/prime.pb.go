...
func (m *PrimeRepose) Reset()         { *m = PrimeRepose{} }
func (m *PrimeRepose) String() string { return proto.CompactTextString(m) }
func (*PrimeRepose) ProtoMessage()    {}
func (*PrimeRepose) Descriptor() ([]byte, []int) {
	return fileDescriptor_f308b80f54e3a336, []int{1}
}

func (m *PrimeRepose) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PrimeRepose.Unmarshal(m, b)
}
func (m *PrimeRepose) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PrimeRepose.Marshal(b, m, deterministic)
}
func (m *PrimeRepose) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PrimeRepose.Merge(m, src)
}
func (m *PrimeRepose) XXX_Size() int {
	return xxx_messageInfo_PrimeRepose.Size(m)
}
func (m *PrimeRepose) XXX_DiscardUnknown() {
	xxx_messageInfo_PrimeRepose.DiscardUnknown(m)
}

var xxx_messageInfo_PrimeRepose proto.InternalMessageInfo

func (m *PrimeRepose) GetOutput() []int64 {
	if m != nil {
		return m.Output
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*PrimeRepose)(nil), "PrimeRepose")
}
...
var fileDescriptor_f308b80f54e3a336 = []byte{
	...
	0x89, 0x04, 0xa3, 0x02, 0xa3, 0x06, 0x73, 0x10, 0x84, 0xa3, 0xa4, 0xca, 0xc5, 0x0d, 0x55, 0x55,
	0x90, 0x5f, 0x9c, 0x2a, 0x24, 0xc6, 0xc5, 0x96, 0x5f, 0x5a, 0x02, 0x51, 0xc5, 0xac, 0xc1, 0x1c,
	0x04, 0xe5, 0x19, 0x19, 0x71, 0xb1, 0x82, 0x95, 0x09, 0x69, 0x72, 0x71, 0xb8, 0xa7, 0x96, 0x40,
	0xd8, 0xbc, 0x7a, 0xc8, 0x16, 0x48, 0xf1, 0xe8, 0x21, 0x99, 0xa4, 0xc4, 0x90, 0xc4, 0x06, 0x76,
	0x87, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x87, 0xc4, 0xc5, 0xfc, 0x9c, 0x00, 0x00, 0x00,
}
